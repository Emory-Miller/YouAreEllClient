...
export const MemberUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...memberEntity,
          user: memberEntity?.user?.id,
          channel: memberEntity?.channel?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField id="member-user" name="user" data-cy="user" label={translate('jiveApp.member.user')} type="select">
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="channel"
                data-cy="channel"
                label={translate('jiveApp.member.channel')}
                type="select"
              >
                <option value="" key="0" />
                {channels
