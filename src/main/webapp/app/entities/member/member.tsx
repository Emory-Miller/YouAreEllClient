          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jiveApp.member.user">User</Translate>
                </th>
                <th>
                  <Translate contentKey="jiveApp.member.channel">Channel</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {memberList.map((member, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{member.user ? member.user.id : ''}</td>
                  <td>{member.channel ? <Link to={`/channel/${member.channel.id}`}>{member.channel.id}</Link> : ''}</td>
