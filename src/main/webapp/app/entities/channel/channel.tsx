          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jiveApp.channel.userProfile">User Profile</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {channelList.map((channel, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{channel.userProfile ? <Link to={`/user-profile/${channel.userProfile.id}`}>{channel.userProfile.id}</Link> : ''}</td>
