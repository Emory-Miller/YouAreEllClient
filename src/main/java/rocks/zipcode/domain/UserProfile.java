...
public class UserProfile implements Serializable {
    ...
    @OneToMany(mappedBy = "userProfile")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "channelMessages", "channelMembers", "userProfile" }, allowSetters = true)
    ...
    public void setChannels(Set<Channel> channels) {
        if (this.channels != null) {
            this.channels.forEach(i -> i.setUserProfile(null));
        }
        if (channels != null) {
            channels.forEach(i -> i.setUserProfile(this));
        }
    ...
    public UserProfile addChannel(Channel channel) {
        ...
        channel.setUserProfile(this);
        return this;
    }

    public UserProfile removeChannel(Channel channel) {
        this.channels.remove(channel);
        channel.setUserProfile(null);
        return this;
    }
